...
## Bridges to tts
##--------------------------------------------------------------------
bridge.mqtt.tts.address = ${common['tts']['SERVER_ADDR']}:${common['tts']['SERVER_PORT']}
...
bridge.mqtt.tts.username = ${common['tts']['API_KEY_USERNAME']}
bridge.mqtt.tts.password = ${common['tts']['API_KEY_PASSWORD']}
...
bridge.mqtt.tts.subscription.1.topic = v3/${common['tts']['API_KEY_USERNAME']}/devices/+/up
