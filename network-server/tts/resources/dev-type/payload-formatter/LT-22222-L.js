function Decoder(bytes, port) {
    ...
    if(mode=='1')
    {
      meta.Work_mode= "2ACI+2AVI";
      decode.AVI1_status= parseFloat(((bytes[0]<<24>>16 | bytes[1])/1000).toFixed(3));
